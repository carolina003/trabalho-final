	...
	<div class="container-fluid" style="padding-left:50px;padding-right:50px;">
		...
		<div class="collapse navbar-collapse" id="website-menu">
			<ul class="nav navbar-nav">
				...
				<li><a class="custom-color" href="index.php">Contato</a></li>
	...
	<div class="row">
		<div class="col-md-9">
			<h3>Contate-nos</h3>
				...
				<fieldset>
					<legend>Como podemos te ajudar? Preencha os espaços abaixo</legend>
					<ol>
						<li>
						...
						<li>
							<label for="description">Dúvidas/Sugestões
							<br>
				...
				<fieldset>
					...
					<ol>
						...
						<li>
							...
							<input id="email"  name="email" placeholder="exemplo@gmail.com" type="email" required/>
				...
				<fieldset>
					<button type="submit" class="btn site-button btn-primary pull-right">Enviar</button>
				</fieldset>
			</form>
			<br/><br/>
